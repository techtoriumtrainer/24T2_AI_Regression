...
model_objects = [lr, svm, rf, gbr, xg, dtr, abr, etr, ls, rg]
rmse_values = [lr_rmse, svm_rmse, rf_rmse, gbr_rmse, xg_rmse, dtr_rmse, abr_rmse, etr_rmse, ls_rmse, rg_rmse]
...
# Create a bar chart
models = ['Linear Regression', 'Support Vector Machine', 'Random Forest', 'Gradient Boosting Regressor', 'XGBRegressor', 'DecisionTreeRegressor', 'AdaBoostRegressor', 'ExtraTreesRegressor', 'Lasso', 'Ridge']
plt.figure(figsize=(10,7))
bars = plt.bar(models, rmse_values, color=['blue', 'green', 'red', 'purple', 'orange', 'cyan', 'magenta', 'yellow', 'black', 'grey' ])
